...
class NmpNet(nn.Module):
    ...
    def __init__(
        ...
        self.mlp1 = make_mlp([h_dim*2+embedding_dim, 512, h_dim], activation=activation, batch_norm=batch_norm, dropout=dropout)
        self.mlp2 = make_mlp([h_dim, 512, bottleneck_dim], activation=activation, batch_norm=batch_norm, dropout=dropout)
    ...
    def init_adj(self, num_ped):
        ...
        off_diag = np.ones([num_ped, num_ped]) - np.eye(num_ped)
